...
import SudiptaResume from "../../Assets/Sudipta_Bhattacharjee_Resume.pdf";
          ...
          <Flex alignItems="center" w="100%" m="auto" justifyContent={"center"}>
            <Box h="640px" p={5} w="50%" fontFamily="poppins" textAlign="start">
              <Box ml={200} mt={150}>
                ...
                <Heading fontFamily="poppins" fontWeight={'400'} size="lg" color="#dc143c" mt={5}>
                  <Typewriter
                    options={{
                      strings: [
                        "Full Stack Web Developer.",
                ...
                <a href={SudiptaResume} target="_blank" download>
                  <Button
                    mt={10}
                    onClick={() => {
                      window.open(SudiptaResume);
                    }}
                    h="50px"
                    fontFamily="Poppins"
                    w="150px"
