    ...
    <>
                    ...
                    <Flex mt={5}>
                      ...
                      <Center>
                        ...
                        <a
                          className={styles.SocialIcon}
                          target="_blank"
                          href="mailto:sudiptabhattacharjee000@gmail.com"
                        >
                          {" "}
                          <Box className={styles.iconBox}>
                            <Flex justifyContent="center" alignItems="center">
                        ...
                        <a
                          className={styles.SocialIcon}
                          target="_blank"
                          href="https://api.whatsapp.com/send/?phone=9073777793&text=I%27m+interested+to+talk+with+you!&type=phone_number&app_absent=0"
                        >
                          <Box ml={10} className={styles.iconBox}>
                            <Flex justifyContent="center" alignItems="center">
                              <BsTelephoneFill
      ...
      <Tablet>
        <Box pt={10} pb={10} fontFamily="poppins" textAlign="center">
          <Heading className={styles.TabHeading} mt={5} fontFamily="poppins">
            {" "}
            Take a <span style={{ color: "#dc143c" }}> Coffee </span>And{" "}
            <span style={{ color: "#dc143c" }}>chat</span> with me
          </Heading>
                      ...
                      <Flex mt={5}>
                        ...
                        <Center>
                          ...
                          <a
                            className={styles.SocialIcon}
                            target="_blank"
                            href="https://api.whatsapp.com/send/?phone=919073777793&text=I%27m+interested+to+talk+with+you!&type=phone_number&app_absent=0"
                          >
                            <Box ml={10} className={styles.iconBox}>
                              <Flex justifyContent="center" alignItems="center">
                                <BsTelephoneFill
      ...
      <Mobile>
        <Box pt={10} w="120%" pb={10} fontFamily="poppins" textAlign="center">
          <Heading
