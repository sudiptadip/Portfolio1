...
export default function Showcase() {
  ...
  const dog = useSelector((data) => data.filter((e) => e.id == params.id));
  console.log(dog);
  ...
  return (
    <div style={{ backgroundColor: "#FFFFF0" }}>
      ...
      <div className="link">
        <div>
          <a target={"blank"} href={dog[0].git}>
            Git-Hub --> Click
          </a>
        </div>
        <div>
          <a target={"blank"} href={dog[0].link}>
            {" "}
            Deploy-Link --> Click
          </a>
        </div>
      ...
      <div className="thirdimg">
        <img src={dog[0].img2} alt="" />
      </div>

      <div className="fourthimg">
        <img src={dog[0].img3} alt="" />
      </div>
      ...
      <div className="fifthimg">
        <img src={dog[0].img4} alt="" />
      </div>

      <div className="sixthimg">
        <img src={dog[0].img5} alt="" />
      </div>
